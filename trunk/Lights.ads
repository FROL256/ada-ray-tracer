...
package Lights is
  ...
  function Sample(l : Light; gen : RandRef; lluminatingPoint : float3) return ShadowSample is abstract;
  ...
  function Sample(l : LightRef; gen : RandRef; lluminatingPoint : float3) return ShadowSample;
  ...
  function Sample(l : AreaLight; gen : RandRef; lluminatingPoint : float3) return ShadowSample;
  ...
  function Sample(l : SphereLight; gen : RandRef; lluminatingPoint : float3) return ShadowSample;
